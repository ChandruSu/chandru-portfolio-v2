...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: ({ children }) => <h1 className="py-2 text-3xl font-medium">{children}</h1>,
    h2: ({ children }) => <h2 className="py-2 text-2xl font-medium">{children}</h2>,
    h3: ({ children }) => <h3 className="py-2 text-xl font-medium">{children}</h3>,
    h4: ({ children }) => <h4 className="py-2 text-lg font-medium">{children}</h4>,
